...
```
## 1.0 Cambios
- Cada ves q se solicite un cambio revisar la rama y preguntar si se trabaja en la última version o se crea una nueva rama, nunca trabajar en la rama mail.
...
- Siempre actualizar Readme antes de pasar a merga verificar en readme que la última actualización corresponda a la ultima versión de la aplicación.
